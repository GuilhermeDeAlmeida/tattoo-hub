...
exports.prepare = function (Model, associations, driver) {
	Model.hasMany = function () {
		...
		opts.mergeTable = opts.mergeTable || (Model.table + "_" + name);
		...
		Model['findBy' + assocName] = function(){
			...
			if(otherModel != null)
				sell[opts.mergeTable + "." + opts.field] = otherModel.id;
			Model.find(sell, {
				"__merge" : {
					"from" : {
						"table" : opts.mergeTable,
						"field" : opts.mergeId || (Model.table + "_id")
					},
					"to" : {
						"table" : Model.table,
						"field" : "id"
				...
				"extra_info" : {
					table: opts.mergeTable,
					id: otherModel.id,
					id_prop: opts.mergeId || (Model.table + "_id"),
					assoc_prop: opts.mergeAssocId || (name + "_id")
				}
			}, cb);
		};
